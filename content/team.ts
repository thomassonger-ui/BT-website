...
export const team: TeamMember[] = [
  {
    ...
    name: "Bethanne Baer",
    title: "Broker/Owner",
    bio: "Bethanne Baer has spent more than four decades helping Central Floridians buy and sell homes — over 7,000 closed homes and more than $4 billion in career volume. She founded Bear Team Real Estate as a boutique alternative to the big-box brokerages: a team small enough to know every client and every street, and experienced enough to handle anything a transaction can produce. Her deepest roots are in the Conway, Edgewood, and Belle Isle corridor, where she has guided families through multiple generations of moves. Every Bear Team consultation with Bethanne is free, 30 minutes, and obligation-free. She holds the GRI, CRS, ABR, and e-PRO designations.",
    designations: ["GRI", "CRS", "ABR", "e-PRO"],
    profileSections: [
      {
        heading: "Rooted in Conway. Invested in Its Future.",
        body: "Bethanne does more than sell homes in the community — she actively supports the families who live here. For more than a decade, Bethanne and the Bear Team have supported local Title I schools by donating school supplies to students who need them most. Her commitment to Conway extends well beyond the closing table.",
      },
    ],
