...
export const communities: Community[] = [
  ...
  },
  {
    ...
    name: "Baldwin Park",
    intro:
      "A New Urbanist neighbourhood inside the City of Orlando, built on the site of the former Naval Training Center Orlando \u2014 which means its ground has an environmental record most Orlando neighbourhoods do not, and a buyer should know how to read it.",
    lifestyle:
      "New Broad Street forms the Village Center beside Lake Baldwin, with a grid of small blocks designed so that no home sits far from a park, roughly 200 acres of common open space, and the Lake Baldwin Trail connecting to the Cady Way Trail toward Winter Park.",
    locationContext:
      "North-east Orlando between Winter Park and Audubon Park, on ground that was sealed behind a military perimeter fence for six decades until the plan reconnected it to the surrounding street grid at around twenty-seven points.",
    housingOverview:
      "Everything here post-dates 2002. Demolition began in April 2000, the first residents moved in during December 2002, and the Village Center opened in October 2003. The plan mixes single-family detached houses, townhouses and row houses, stacked flats, apartments above ground-floor retail, and accessory units \u2014 deliberately, as a New Urbanist principle rather than as an accident of phasing.",
    propertyTypes: [
      "Single-family detached homes",
      "Townhomes and row houses",
      "Stacked flats and apartments",
      "Apartments above ground-floor retail",
      "Accessory dwelling units",
    ],
    buyerConsiderations: [
      "Ask specifically about environmental institutional controls on the parcel \u2014 the former base carries recorded land-use restrictions in defined areas, and a title search plus a Florida DEP records check is the way to establish whether any touch a given address",
      "Every exterior change goes through the Residential Owners Association\u2019s Architectural Review Committee before work begins, and applications can wait weeks to be scheduled",
      "Public infrastructure is funded through the Urban Orlando Community Development District \u2014 a Chapter 190 special district whose assessments appear on the tax bill separately from association dues",
      "The neighbourhood sits under a City of Orlando Planned Development ordinance adopted in 1998, so its zoning rules are the PD\u2019s own, not the standard city code",
    ],
    sellerConsiderations: [
      "Buyers and their lenders increasingly ask about the base history directly; having the answer ready, with the parcel\u2019s title work in hand, is better than being asked cold",
      "Because the housing is uniform in age, condition and finish level do most of the pricing work",
      "Unpermitted exterior changes are unusually visible here, since the ARC record establishes what was approved",
    ],
    amenities: [
      "Village Center on New Broad Street",
      "Lake Baldwin and the Lake Baldwin Trail",
      "Cady Way Trail",
      "Blue Jacket Park",
      "Roughly 200 acres of common open space",
    ],
    transportation: [
      "Bennett Road",
      "Corrine Drive",
      "General Rees Avenue",
      "SR 50 / East Colonial Drive nearby",
      "Cady Way Trail",
      "LYNX bus network",
    ],
    extraSections: [
      {
        heading: "What the Navy left, and how to check it",
        body: [
          "Naval Training Center Orlando was one of the Navy\u2019s largest training bases. The 1993 BRAC round marked it for closure; Recruit Training Command and the naval hospital closed in 1995, Service School Command in 1996, and the Nuclear Power Training Command graduated its last class in December 1998. All base operations ceased on 30 April 1999. The Navy conveyed the property in October 1999, the City having selected Orlando NTC Partners as master developer in May 1998.",
          "A 1994 environmental baseline survey identified fifty-five potential areas of contamination across the base, along with roughly two hundred petroleum storage tanks that were subsequently removed. Groundwater contamination included the solvents trichloroethene and tetrachloroethene; soil and groundwater work also addressed lead, arsenic and pesticides. Around one hundred acres of the main base underwent arsenic remediation. One area, the North Grinder Landfill at the north-west corner, had operated as a landfill from 1939 to 1968 and became the subject of a 1998 EPA Record of Decision.",
          "That Record of Decision imposed real, lasting restrictions on that specific footprint: a prohibition on using the surficial aquifer for water, a bar on intrusive activity deeper than twelve inches without protective protocols, and a restriction limiting land use within the landfill and groundwater-restriction boundary to non-residential purposes. Two parcels were transferred while contamination remained, under a Finding of Suitability for Early Transfer signed in December 2002 \u2014 the mechanism used when obligations continue to run with the land. The EPA has said long-term monitoring at the former base is ongoing.",
          "None of that means a given house is affected. The controls attach to defined areas, not uniformly to every residential lot, and in 2020 the EPA gave the Navy, Florida DEP, the City and the developer a national award for the site\u2019s reuse. What it does mean is that the honest answer to \u201cis this property clear?\u201d is a title search and a Florida DEP records check for that parcel, not a reassurance from anybody\u2019s website \u2014 including ours. We could not map the restricted boundary against present-day addresses from published sources, so we will not pretend to.",
        ],
      },
      {
        heading: "Two bills, one address",
        body: [
          "Baldwin Park carries two layers of obligation beyond ordinary city taxes, and buyers regularly budget for one and meet the other at closing.",
          "The first is the Residential Owners Association, which administers the community\u2019s design guidelines through an Architectural Review Committee. Every exterior property change needs ARC approval before work starts, and scheduling can take weeks, particularly in season. That is the trade the design consistency is bought with.",
          "The second is the Urban Orlando Community Development District, created under Chapter 190 of the Florida Statutes by Orange County ordinance effective 6 December 1999, covering roughly 999 acres. A CDD is a unit of local government, not a homeowners association: it finances and maintains public infrastructure and levies its own assessments, which arrive on the annual property tax bill as a non-ad-valorem line rather than as dues. Ask for the parcel\u2019s actual tax bill and read that line before you agree a monthly payment.",
          "The land-use rules are the Planned Development\u2019s own. The PD ordinance was adopted on 27 July 1998 and runs to thirteen chapters plus architectural, landscaping and signage appendices. It sets aside roughly 200 acres of common open space closed to future development, targets a five-minute walk from any home to a neighbourhood park, and prohibits public boat ramps on Lake Susannah. Lake Baldwin covers about 196 acres and Lake Susannah about 78.",
        ],
      },
    ],
    image: "/images/communities/baldwin-park.jpg",
    imageAlt: "Brick street and mixed-use buildings at the Village Center on New Broad Street, Baldwin Park, Orlando",
    gallery: [
      { src: "/images/communities/baldwin-park-lake.webp", alt: "Homes along the shoreline of Lake Baldwin, Orlando" },
      { src: "/images/communities/baldwin-park-village-center.webp", alt: "New Broad Street looking through the Village Center, Baldwin Park, Orlando" },
    ],
    photoCredit: {
      text: "Village Center streetscape \u00a9 Dclemens1971 and \u00a9 Freeholdman12 (CC BY 4.0), via Wikimedia Commons",
      href: "https://commons.wikimedia.org/wiki/Category:Baldwin_Park,_Orlando,_Florida",
    },
    related: ["orlando", "audubon-park", "winter-park"],
    reviewNote:
      "Facts sourced: US Navy BRAC PMO former-NTC-Orlando page and EPA Federal Facilities 'Site Spotlight' plus EPA's NTC Orlando success-story PDF (1993 BRAC decision; phased closures 1995/1996/Dec 1998; all operations ceased 30 April 1999; 1994 baseline survey identifying 55 potential contamination areas and ~200 storage tanks; TCE/PCE groundwater, lead/arsenic/pesticides; ongoing long-term monitoring); EPA Record of Decision EPA/ROD/R04-98/503 via semspub.epa.gov for Operable Unit 1, the North Grinder Landfill (landfill operated 1939-1968; institutional controls = surficial-aquifer use restriction, no intrusive activity below 12 inches, and land use restricted to NON-RESIDENTIAL within the landfill and groundwater-restriction boundary); EPA success story for the December 2002 Finding of Suitability for Early Transfer; EPA news release Nov 2020 for the site-reuse award; City of Orlando Baldwin Park history PDF and PD document set (master developer Orlando NTC Partners selected May 1998; PD ordinance adopted 27 July 1998; ~200 acres common open space; no public boat ramps on Lake Susannah; five-minute-walk park standard); Orange County Water Atlas (Lake Baldwin 196 acres, Lake Susannah 78 acres); Urban Orlando CDD official site (Chapter 190 district, Orange County ordinance effective 6 Dec 1999, ~999 acres); Orange Observer Jan 2024 for the ARC approval process and timing. CRITICAL CAVEATS STATED ON THE PAGE: the OU1 restricted-area boundary could NOT be mapped against present-day residential parcels, and no Florida DEP Institutional Control Registry entry was located for specific Baldwin Park residential parcels - the page therefore tells buyers to run a title search and a DEP records check rather than asserting any property is clear or affected. ALSO NOT VERIFIED: the PD ordinance NUMBER (only its 27 July 1998 adoption date); whether the CDD boundary exactly coincides with the PD boundary; whether alley-loaded garages are a mandated PD standard (widely claimed in marketing, not found in the primary ordinance text) - none of these are asserted. Unit counts vary between the 1998 RFP response and later documents, so no single unit figure is published.",
  },
  {
    slug: "winter-garden",
    name: "Winter Garden",
  ...
  },
  {
    ...
    name: "Thornton Park",
    intro:
      "A brick-street neighbourhood immediately east of Lake Eola, inside the City of Orlando and inside the Lake Lawsona Historic District \u2014 which is the fact that governs what an owner may do to the outside of a house here.",
    lifestyle:
      "Thornton Park District Main Street runs as a walkable commercial spine, part of the City\u2019s Main Street programme, a short walk from the Lake Eola loop and Dickson Azalea Park.",
    locationContext:
      "Inside the City of Orlando, bounded by Robinson Street to the north, SR 408 to the south, Hampton Avenue to the east and Summerlin Avenue to the west \u2014 the boundaries of the Lake Lawsona Historic District itself.",
    housingOverview:
      "The housing dates largely from just after the turn of the twentieth century to the Second World War: Craftsman bungalows, notably along Washington Street, alongside Frame and Masonry Vernacular, Mediterranean, Mission, Tudor, Neoclassical and Colonial Revival houses. The National Register records a period of significance running from 1887 to 1949.",
    propertyTypes: [
      "Craftsman bungalows",
      "Mediterranean and Mission Revival houses",
      "Frame and Masonry Vernacular homes",
      "Colonial and Neoclassical Revival houses",
      "Later infill and townhomes",
    ],
    buyerConsiderations: [
      "The house is almost certainly inside a locally designated historic district, which means exterior work needs a Certificate of Appropriateness before a building permit \u2014 confirm the parcel with the City rather than assuming",
      "Minor review covers fences, awnings, driveways, paint and roof colour where required, window and siding replacement, doors, lighting and solar; it is handled by staff with no fee and no hearing",
      "Major review covers additions, major alterations, garage apartments, demolition and new construction \u2014 a Historic Preservation Board hearing followed by City Council final approval, on the boards\u2019 meeting schedules rather than a fixed clock",
      "Houses of this age warrant attention to roof, electrical service, supply lines and window condition, confirmed by inspection rather than assumption",
    ],
    sellerConsiderations: [
      "Unpermitted exterior work on a designated property surfaces during diligence and is slow to cure, because the fix runs through the same review the original work skipped",
      "Original detail \u2014 floors, windows, trim, porches \u2014 tends to separate offers here more than square footage does",
      "A buyer planning an addition will want to know the major-review path before making an offer, and a seller who can explain it holds the conversation",
    ],
    amenities: [
      "Lake Eola Park",
      "Thornton Park District Main Street",
      "Dickson Azalea Park",
      "Lake Lawsona Park",
      "Lake Cherokee Park",
    ],
    transportation: [
      ...
      "LYNX bus network",
      "SunRail downtown station nearby",
    ],
    extraSections: [
      {
        heading: "Local designation, national listing, and the difference that costs money",
        body: [
          "Thornton Park sits inside the Lake Lawsona Historic District, which the City of Orlando designated locally in 1994. The City describes the district as consisting of the Lawsona/Fern Creek and Thornton Park neighbourhoods, bounded by Robinson Street, SR 408, Hampton Avenue and Summerlin Avenue.",
          "The district was separately listed on the National Register of Historic Places on 3 April 2019. Those two things are constantly confused and they do very different work. The 1994 local ordinance is what subjects a property to City design review. The 2019 National Register listing is a federal and state honour \u2014 the City itself says of National Register districts, in its own planning document, that they are not regulatory. If you want to know whether you need permission to change a window, the local designation is the answer, not the national one.",
          "One further note worth having straight, because it made the news. In June 2026 Orlando City Council voted to suspend Certificate of Appropriateness review for three years, effective 10 August 2026. That suspension applies to the Downtown Historic District only \u2014 a small area of named landmark buildings \u2014 and residential historic districts were excluded. Review in Lake Lawsona continues unchanged. Anyone told otherwise has read a headline rather than the ordinance.",
          "In practice: minor review is staff-level, no fee and no hearing, and the City says it will contact an applicant within five days with a project number. Major review \u2014 additions, major alterations, garage apartments, demolition, new construction \u2014 requires a pre-application meeting, a $250 fee, a Historic Preservation Board hearing, and final approval by City Council, timed to those bodies\u2019 meeting schedules. All of it is judged against the Secretary of the Interior\u2019s Standards for Rehabilitation.",
        ],
      },
      {
        heading: "The park, the main street and the water",
        body: [
          "Lake Eola Park is the neighbourhood\u2019s western anchor and the City\u2019s central urban park: about 23 acres, expanded by roughly 1.36 acres to the south-east in 2013. The land was first donated in 1883 and the park formally declared in 1892; the City has held and maintained it since.",
          "Thornton Park District is one of the City\u2019s official Main Street districts, run by a nonprofit board under the Main Street Four Point approach with technical assistance from the City. The City describes it as a walkable commercial district of more than sixty locally owned shops, services and dining destinations.",
          "The smaller water bodies matter to the street pattern rather than to boating. Lake Lawsona covers about 8 acres and Lake Cherokee about 12, each with a City park beside it \u2014 Lake Lawsona Park on East Jackson Street and Lake Cherokee Park nearby. Dickson Azalea Park occupies the Fern Creek ravine on land donated by Walter Rose, the early developer of this part of the district.",
        ],
      },
    ],
    image: "/images/communities/thornton-park.jpg",
    imageAlt: "Mediterranean Revival house on a brick street in the Lake Lawsona Historic District, Thornton Park, Orlando",
    gallery: [
      { src: "/images/communities/thornton-park-bungalow.webp", alt: "Craftsman bungalow with a deep front porch in the Lake Lawsona Historic District, Orlando" },
      { src: "/images/communities/thornton-park-mediterranean.webp", alt: "Mission Revival bungalow with palms on a brick street, Lake Lawsona Historic District, Orlando" },
      { src: "/images/communities/thornton-park-craftsman.webp", alt: "Craftsman bungalow beneath an oak canopy in the Lake Lawsona Historic District, Orlando" },
    ],
    photoCredit: {
      text: "Lake Lawsona Historic District houses \u00a9 Ebyabe (CC BY-SA 4.0), via Wikimedia Commons",
      href: "https://commons.wikimedia.org/wiki/Category:Lake_Lawsona_Historic_District",
    },
    related: ["orlando", "delaney-park", "college-park"],
    reviewNote:
      "Facts sourced: City of Orlando Historic Preservation Element support document, approved 12 Aug 1991 and amended 26 July 2010 (the six LOCAL districts with designation years; the Lake Lawsona boundary of Robinson St / SR 408 / Hampton Ave / Summerlin Ave; district composition as the Lawsona-Fern Creek and Thornton Park neighbourhoods; the architectural styles and Walter Rose donating the land that became Dickson Azalea Park; AND the City's own explicit statement that National Register districts 'are not regulatory' - which is the basis for the local-versus-national paragraph); NPGallery/NRHP reference #100003410 and the Florida Department of State press release of June 2019 (National Register listing 3 April 2019; period of significance 1887-1949; and the state's own note that the district was locally designated in 1994); City of Orlando Certificate of Appropriateness application pages, fetched Aug 2026 (minor review scope, staff-level, no fee, five-day contact; major review scope, pre-application meeting, $250 fee, HPB hearing then CITY COUNCIL final approval, timed to meeting schedules); City of Orlando Orlando Main Streets pages (Thornton Park District listed; programme structure; the City's own 'more than 60 locally-owned' description); Wikipedia/City parks for Lake Eola Park (23 acres, 1.36-acre 2013 expansion, 1883 donation, 1892 declaration) and Orange County Water Atlas (Lake Lawsona 8 acres, Lake Cherokee 12 acres). The June 2026 Certificate of Appropriateness SUSPENSION is sourced to Central Florida Public Media and MAST Newsroom reporting of the 22 June 2026 Council vote, effective 10 Aug 2026, DOWNTOWN DISTRICT ONLY with residential districts excluded - the page states this scope explicitly because owners here will otherwise misread the headline. NOT VERIFIED and therefore not asserted: the exact reconciliation of the NRHP boundary ('South & Robinson Sts') against the wider local boundary; a date for the brick streets' installation; an original platted subdivision name; the 2012 date for Thornton Park's admission to the Main Street programme (community-newspaper source only); acreage of Lake Lawsona Park and Lake Cherokee Park as facilities. A 2010 City document gives a ten-day minor-review turnaround while the current pages give a five-day initial contact; the page follows the current pages.",
  },
  {
    slug: "delaney-park",
    name: "Delaney Park",
    intro:
      "Three different things in south Orlando share the Delaney name \u2014 a 7.25-acre city park, an official City neighbourhood, and two historic districts that border it but do not contain it. Buyers conflate them constantly, and the difference decides whether design review applies.",
    lifestyle:
      "A quiet residential grid south of downtown, wrapped around Lake Lancaster, with the Delaney Avenue corridor running along its western edge and Orlando Health a short distance beyond.",
    locationContext:
      "Inside the City of Orlando, in Commissioner District 4: bounded roughly by Delaney Park Drive and East Gore Street to the north, Fern Creek Avenue to the east, East Kaley Street to the south, and Delaney Avenue and South Osceola Avenue to the west.",
    housingOverview:
      "The housing runs from the 1920s through to recent construction under mature oaks, on a street grid laid out well before the neighbourhoods around it filled in. Because the area carries no historic-district overlay of its own, the range of what has been built and rebuilt here is wider than in Lake Cherokee or Lake Copeland next door.",
    propertyTypes: [
      "1920s and 1930s houses",
      "Mid-century homes",
      "Lakefront homes on Lake Lancaster",
      "Later infill and new construction",
    ],
    buyerConsiderations: [
      "Establish which side of Delaney Avenue and which side of East Gore Street the parcel sits on \u2014 that single fact decides whether a historic district and its design review apply",
      "Inside the Delaney Park neighbourhood itself there is no local historic designation, so exterior work follows ordinary City of Orlando permitting rather than a Certificate of Appropriateness",
      "Older houses here warrant the usual attention to roof, electrical service, supply lines and window condition, confirmed by inspection",
      "Lake Lancaster is the lake actually inside the neighbourhood boundary; Lake Davis, Lake Cherokee and Lake Copeland each sit in adjoining neighbourhoods",
    ],
    sellerConsiderations: [
      "Marketing that implies a historic-district address when the parcel sits outside one is a real misrepresentation risk \u2014 the City publishes the district maps and buyers check them",
      "The absence of design review is a genuine selling point to a buyer who intends to alter or extend, and worth stating plainly rather than leaving them to discover",
      "Permit history on a house of this age is worth pulling before listing rather than during a contract",
    ],
    amenities: [
      "Delaney Park (city park), 1055 Delaney Avenue",
      "Lake Lancaster",
      "Lake Davis Park nearby",
      "Lake Cherokee Park nearby",
      "Orlando Health campus nearby",
    ],
    transportation: [
      "Delaney Avenue",
      "South Orange Avenue",
      "East Kaley Street",
      "SR 408 East\u2013West Expressway nearby",
      "LYNX bus network",
    ],
    extraSections: [
      {
        heading: "Three Delaneys, and which one you are buying in",
        body: [
          "The city park is the smallest of the three. Delaney Park sits at 1055 Delaney Avenue, covers 7.25 acres, and was originally called Duckworth Park before it was renamed in 1959. It has baseball and softball fields without lighting, hard-surface tennis courts, two playgrounds split by age, picnic areas and restrooms, and it is open sunrise to sunset.",
          "The neighbourhood is much larger and is an official City of Orlando designation, mapped by City GIS with boundaries adopted by City Council on 20 June 2022. It sits in Commissioner District 4. Lake Lancaster, about 43 acres, is the one substantial lake inside that polygon. Lake Davis, Lake Cherokee and Lake Copeland each sit inside their own separately named adjoining neighbourhoods, not inside Delaney Park \u2014 which is why a listing that advertises \u201cDelaney Park, steps from Lake Davis\u201d is describing two neighbourhoods.",
          "Then there are the historic districts, and this is the part with money attached. Lake Cherokee Historic District, designated locally in 1981, runs along East Gore Street to the north. Lake Copeland Historic District, designated in 1984, sits west of Delaney Avenue between Annie Street and Miller Street. Both share a boundary line with the Delaney Park neighbourhood. Neither overlaps its interior. There is no Delaney Park Historic District \u2014 the City lists six local districts and this is not among them.",
          "The practical consequence is a hard edge. A house on the west side of Delaney Avenue may need a Certificate of Appropriateness from the City before its owner can change a window; a house on the east side, in Delaney Park proper, does not. Same street, different rulebook. Confirm the parcel against the City\u2019s published district maps before you plan any exterior work, and before you price the property on the assumption either way.",
          "One current note: in June 2026 Orlando City Council suspended Certificate of Appropriateness review for three years, effective 10 August 2026. That applies to the Downtown Historic District only. Lake Cherokee and Lake Copeland are unaffected and their review continues as before.",
        ],
      },
    ],
    image: "/images/communities/delaney-park.jpg",
    imageAlt: "The 1925 S. J. Sligh House on East Copeland Drive, in the Lake Copeland Historic District bordering Delaney Park, Orlando",
    gallery: [
      {
        src: "/images/communities/delaney-park-sligh.webp",
        alt: "The neoclassical S. J. Sligh House of 1925, East Copeland Drive, Lake Copeland Historic District, Orlando",
      },
      {
        src: "/images/communities/delaney-park-newell.webp",
        alt: "The George R. Newell House on South Lake Avenue, in the Lake Cherokee Historic District bordering Delaney Park, Orlando",
      },
    ],
    photoCredit: {
      text: "The Sligh House (239 E. Copeland Drive) and the Newell House (S. Lake Avenue) \u2014 both in the historic districts bordering Delaney Park, not inside it \u00a9 Ebyabe (CC BY-SA 3.0), via Wikimedia Commons",
      href: "https://commons.wikimedia.org/wiki/Category:Houses_in_Orlando,_Florida",
    },
    related: ["orlando", "thornton-park", "college-park"],
    reviewNote:
      "Facts sourced: City of Orlando parks directory for Delaney Park at 1055 Delaney Avenue (7.25 acres, formerly Duckworth Park, renamed 1959, facilities and sunrise-sunset hours); City of Orlando GIS official neighbourhood map for Delaney Park at gis.orlando.gov (boundaries adopted by City Council 20 June 2022, Doc# 2206201202; Commissioner District 4; Lake Lancaster the lake inside the polygon; adjoining neighbourhoods named as Lake Cherokee, Lake Weldona, Lake Davis/Greenwood, Lancaster Park and Wadeview Park); the 1981 Lake Cherokee Historic District ordinance PDF on orlando.gov for its metes-and-bounds boundary including the East Gore Street and Delaney Avenue lines; City of Orlando Historic Preservation Element and the City's Historic Preservation Districts page for the six LOCAL districts and the Lake Copeland boundary (Annie St north, Delaney Ave east, Miller St south, east of Orange Ave, designated 1984); gis.orlando.gov Lake Copeland district map, read directly, confirming the district runs along the WEST side of Delaney Avenue only; Orange County Water Atlas for lake acreages (Lancaster 43, Davis 18, Cherokee 12, Copeland 15). The June 2026 Certificate of Appropriateness suspension is sourced to Central Florida Public Media and Spectrum News 13 reporting of the 22 June 2026 Council vote, effective 10 Aug 2026, DOWNTOWN ONLY. PHOTOS - READ BEFORE CHANGING. Wikimedia Commons and Openverse hold NO photograph inside the Delaney Park neighbourhood boundary; this was checked by category search, full-text search and radius geosearch. The three photographs used are therefore all from the historic districts that BORDER Delaney Park, and every caption and the visible credit line say so explicitly. Cover and one tile: the S. J. Sligh House, 239 East Copeland Drive, built 1925 in neoclassical revival style for citrus shipper Samuel James Sligh (address and 1925 date per Orlando Weekly), which sits in the Lake Copeland Historic District immediately west of Delaney Avenue - the exact boundary this page is about, which is why it is editorially apt rather than a substitute. Second tile: the George R. Newell House on South Lake Avenue in the Lake Cherokee Historic District, which borders Delaney Park along East Gore Street; note its Wikipedia entry records it was NRHP-listed and delisted in 1975 and describes the present structure as a new house built near the original location, so it must NOT be captioned as an intact historic landmark. All three by Ebyabe, CC BY-SA 3.0. The previous cover was 1200x671, soft, and of unverified provenance. A photograph of a house actually inside Delaney Park still requires Bear Team's own camera. Do not relabel any of these as being in Delaney Park. ALSO NOT VERIFIED and not asserted: the 'brick streets' characterisation (Wikipedia only, and that article carries disputed/citations-needed tags); whether Delaney Park is formally named in the City's Traditional City land-use designation; acreage and facilities for Lake Lancaster Park; any Census geography coextensive with the neighbourhood - none exists, so no neighbourhood-level statistics are published.",
  },
  {
    slug: "audubon-park",
    name: "Audubon Park",
    intro:
      "A post-war neighbourhood inside the City of Orlando, built on land annexed in the 1950s, wrapped around Lake Druid and bordered by Corrine Drive \u2014 where a long-running City complete-streets project is the thing most likely to change life on the ground.",
    lifestyle:
      "Harry P. Leu Gardens sits on the neighbourhood\u2019s western side, the Cady Way Trail runs through toward Winter Park, and the Corrine Drive corridor carries the commercial district that trades under the Audubon Park Garden District name.",
    locationContext:
      "North-east Orlando in Commissioner District 3, bordered by Corrine Drive, Virginia Drive, Utah Boulevard and Bennett Road, with Baldwin Park immediately east along the same Corrine Drive corridor and Winter Park to the north.",
    housingOverview:
      "The neighbourhood was laid out as a post-war subdivision in the 1950s, and the housing reflects it: single-storey homes of that era on regular lots under mature canopy, with later renovation and replacement mixed through. Nothing here carries a historic-district overlay, so alteration and rebuilding have proceeded without design review.",
    propertyTypes: [
      "1950s single-storey homes",
      "Mid-century ranch houses",
      "Renovated post-war homes",
      "Later infill and new construction",
    ],
    buyerConsiderations: [
      "There is no local historic designation here, so exterior work follows ordinary City of Orlando permitting rather than a Certificate of Appropriateness \u2014 a meaningful difference from Thornton Park or College Park",
      "The Virginia\u2013Forest\u2013Corrine corridor project will change the street a property fronts or backs onto; check the City project page for the current segment and schedule before you buy on or near Corrine Drive",
      "Houses of this era commonly warrant attention to roof age, electrical panel type, supply-line material and window condition, confirmed by inspection",
      "Confirm the parcel is inside City of Orlando limits rather than unincorporated Orange County \u2014 the boundary in this part of the metro is not tidy, and the Property Appraiser record settles it",
    ],
    sellerConsiderations: [
      "The absence of design review is a genuine advantage to a buyer intending to renovate, and worth saying rather than leaving them to find out",
      "Buyers ask about the Corrine Drive project directly; knowing which segment is funded and which is not is better than a vague answer",
      "On a house of this age a pre-listing four-point inspection lets you price the roof, panel and plumbing questions instead of having a buyer price them for you",
    ],
    amenities: [
      "Harry P. Leu Gardens",
      "Cady Way Trail",
      "Lake Druid Park",
      "Blue Jacket Park nearby",
      "Audubon Park Garden District on Corrine Drive",
    ],
    transportation: [
      "Corrine Drive",
      "Bennett Road",
      "Virginia Drive",
      "East Colonial Drive (SR 50) nearby",
      "Cady Way Trail",
      "LYNX bus network",
    ],
    extraSections: [
      {
        heading: "The Corrine Drive project, and what is actually funded",
        body: [
          "The single most consequential thing happening to this neighbourhood is a road. The City of Orlando runs the Virginia\u2013Forest\u2013Corrine Corridor Project, covering roughly 2.6 miles of Virginia Drive, Forest Avenue and Corrine Drive from Orange Avenue to Bennett Road, applying complete-streets techniques \u2014 pedestrian and bicycle safety, resurfacing, accessibility upgrades. The current improvement focus is the segment between East End Avenue and Northwood Terrace Drive, inside the Garden District.",
          "The sequence so far is documented on the City\u2019s own project page. The City took ownership of these roads from Orange County in January 2022. Interim resurfacing finished in April 2022 at about $31,000. A pedestrian hybrid beacon went in that June at roughly $500,000 from Orlando STOPS safety funds. A quick-build bike path pilot finished in September 2023, and complete-streets engineering and design were funded for FY2024 at about $1.4 million in federal metropolitan-area money, with construction anticipated in FY2026.",
          "The part a buyer should register is the funding gap. The City puts the total estimated project cost at about $22 million, of which roughly $4.6 million is funded and about $14.3 million remains unfunded, and states plainly that construction plans and timelines have yet to be determined. An earlier and separate MetroPlan Orlando complete-streets study for Corrine Drive ran from 2017 to 2019 and is not the live project.",
          "So the honest position is that the corridor is being rebuilt in stages, some of it is paid for and some of it is not, and the schedule is genuinely open. That is worth knowing before assuming either that the street will be transformed next year or that nothing will change.",
        ],
      },
      {
        heading: "The gardens, the airport and the base next door",
        body: [
          "Harry P. Leu Gardens is the defining amenity. Harry and Mary Jane Leu bought the house and about forty acres in 1936 and deeded the property to the City of Orlando in 1961. The gardens now run to nearly fifty acres of landscaped grounds and lakes, and a fifteen-acre portion \u2014 the Mizell-Leu House Historic District, with three historic buildings \u2014 was listed on the National Register of Historic Places on 29 December 1994. It is City-owned and open to the public.",
          "Two pieces of aviation and military history sit on the neighbourhood\u2019s edges and get confused with each other. Orlando Executive Airport, three miles east of downtown, opened in 1928 as Orlando Municipal Airport, became Orlando Army Air Base in 1940, was renamed Herndon Airport in 1961 and took its present name in 1982. Showalter Field is a different place: the original Showalter Airpark operated from 1945 to 1951 and its name now attaches to a sports complex at Cady Way Park in Winter Park.",
          "East along Corrine Drive lies Baldwin Park, built on the former Naval Training Center Orlando, which closed under the 1993 BRAC round. Blue Jacket Park, named for the Navy term for an enlisted sailor, is a remnant of that history. The two neighbourhoods share the Corrine Drive corridor on the City\u2019s own maps.",
          "One thing this neighbourhood does not have is a historic-district overlay. Orlando has six locally designated historic districts and Audubon Park is not among them. For an owner planning to renovate, that absence is not a footnote \u2014 it is the difference between a building permit and a design review.",
        ],
      },
    ],
    image: "/images/communities/audubon-park.jpg",
    imageAlt: "The Leu House at Harry P. Leu Gardens, the City-owned garden beside Audubon Park, Orlando",
    gallery: [
      { src: "/images/communities/audubon-park-leu-house.webp", alt: "The historic Leu House in the Mizell-Leu House Historic District at Harry P. Leu Gardens, Orlando" },
      { src: "/images/communities/audubon-park-leu-gardens.webp", alt: "Planting beds at Harry P. Leu Gardens, the City of Orlando botanical garden beside Audubon Park" },
    ],
    photoCredit: {
      text: "Leu House and gardens \u00a9 KimonBerlin (CC BY-SA 2.0) \u00b7 Mizell-Leu House Historic District \u00a9 Ebyabe (CC BY 2.5) \u2014 via Wikimedia Commons",
      href: "https://commons.wikimedia.org/wiki/Category:Harry_P._Leu_Gardens",
    },
    related: ["baldwin-park", "orlando", "winter-park"],
    reviewNote:
      "NEW PAGE - did not previously exist. Facts sourced: City of Orlando GIS official neighbourhood map for Audubon Park (boundaries adopted by City Council 20 June 2022; Commissioner District 3; boundary streets Corrine Dr, Utah Blvd, Woodside Ave, Finch St, Pelican Ln, Virginia Dr, Jancie Ave, Osprey Ave, E Marks St, Weber St; Lake Druid, Lake Sue, Lake Shannon and others; Lake Druid Park, Blue Jacket Park, Beeman Park, Songbird Park, Mitchell Nutter Park; Cady Way Trail); City of Orlando Virginia-Forest-Corrine Corridor Project page (2.6 miles Orange Ave to Bennett Rd; current focus East End Ave to Northwood Terrace Dr; road ownership transferred from the county Jan 2022; $31,000 interim resurfacing Apr 2022; $500,000 pedestrian hybrid beacon June 2022 from Orlando STOPS funds; quick-build bike pilot Sept 2023; $1,405,000 FY2024 design funding from federal TMA money; construction anticipated FY2026; TOTAL ~$22M with ~$4,555,000 funded and ~$14,300,000 UNFUNDED and 'plans and timelines have yet to be determined' - the funding gap is stated on the page because it is the honest position); MetroPlan Orlando archive for the separate 2017-2019 Corrine Drive study; City of Orlando Orlando Main Streets pages (Audubon Park Garden District is an official Main Street district; programme created 2008); Harry P. Leu Gardens history (Leus purchased house and ~40 acres 1936, deeded to the City 1961, now ~50 acres; Mizell-Leu House Historic District, 15 acres and three buildings, National Register 29 Dec 1994); Orlando Executive Airport name history and the SEPARATE Showalter Field, which is a Winter Park sports complex and NOT a former name of the airport - the page states this because the two are routinely conflated; City of Orlando Historic Preservation Districts page confirming Audubon Park is NOT among the six local districts. NOT VERIFIED and therefore hedged or omitted: the exact year Audubon Park Garden District was admitted to the Main Street programme, and any Garden District boundary map distinct from the residential neighbourhood map; the 1953 annexation and Conway D. Kittredge development narrative, which rests on a community-newspaper source only, so the page says 'annexed in the 1950s' and 'laid out as a post-war subdivision in the 1950s' rather than citing figures; current Leu Gardens admission pricing; an explicit City statement that Audubon Park borders Baldwin Park (inferred from the two official GIS maps sharing Corrine Drive). NO PHOTOGRAPHS EXIST on Wikimedia Commons inside the Audubon Park neighbourhood - full-text, category and 2km radius geosearches all returned nothing. The photographs used are Harry P. Leu Gardens, which is adjacent rather than inside, and every caption says Leu Gardens explicitly rather than implying a neighbourhood streetscape. FEMA images of children inside Audubon Park Elementary were found and deliberately excluded as unsuitable subject matter regardless of licence.",
  },
  {
    slug: "maitland",
    name: "Maitland",
