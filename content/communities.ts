...
export const communities: Community[] = [
  ...
  },
  {
    ...
    imageAlt: "Residential street beneath mature oaks in the Delaney Park neighbourhood, Orlando",
    related: ["orlando", "thornton-park", "college-park"],
    reviewNote:
      "Facts sourced: City of Orlando parks directory for Delaney Park at 1055 Delaney Avenue (7.25 acres, formerly Duckworth Park, renamed 1959, facilities and sunrise-sunset hours); City of Orlando GIS official neighbourhood map for Delaney Park at gis.orlando.gov (boundaries adopted by City Council 20 June 2022, Doc# 2206201202; Commissioner District 4; Lake Lancaster the lake inside the polygon; adjoining neighbourhoods named as Lake Cherokee, Lake Weldona, Lake Davis/Greenwood, Lancaster Park and Wadeview Park); the 1981 Lake Cherokee Historic District ordinance PDF on orlando.gov for its metes-and-bounds boundary including the East Gore Street and Delaney Avenue lines; City of Orlando Historic Preservation Element and the City's Historic Preservation Districts page for the six LOCAL districts and the Lake Copeland boundary (Annie St north, Delaney Ave east, Miller St south, east of Orange Ave, designated 1984); gis.orlando.gov Lake Copeland district map, read directly, confirming the district runs along the WEST side of Delaney Avenue only; Orange County Water Atlas for lake acreages (Lancaster 43, Davis 18, Cherokee 12, Copeland 15). The June 2026 Certificate of Appropriateness suspension is sourced to Central Florida Public Media and Spectrum News 13 reporting of the 22 June 2026 Council vote, effective 10 Aug 2026, DOWNTOWN ONLY. NO PHOTOS BEYOND THE EXISTING COVER: targeted Wikimedia Commons full-text, category and radius geosearches found NO photograph located inside the Delaney Park neighbourhood boundary. Nearby house photos exist but sit in Lake Cherokee or near Lake Lucerne downtown, and publishing them as Delaney Park would be a geographic misrepresentation on a page whose whole argument is that these boundaries are distinct - so no gallery is published. Bear Team's own photography is the fix. ALSO NOT VERIFIED and not asserted: the 'brick streets' characterisation (Wikipedia only, and that article carries disputed/citations-needed tags); whether Delaney Park is formally named in the City's Traditional City land-use designation; acreage and facilities for Lake Lancaster Park; any Census geography coextensive with the neighbourhood - none exists, so no neighbourhood-level statistics are published.",
  },
  {
    slug: "audubon-park",
    name: "Audubon Park",
