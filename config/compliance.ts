/**
 * Compliance language used across the site. Every string here requires
 * qualified legal / brokerage review before launch (COMPLIANCE_REVIEW.md).
 * Nothing on this site should be represented as legally compliant until that
 * review is complete.
 */
...
export const compliance = {
  ...
  marketDataDisclaimer:
    "Market information is provided for general education, may change without notice, and should be independently verified before making real estate decisions.",

  thirdPartySearchDisclaimer:
    "Property-search services may be provided through an independent third-party website. Availability, accuracy, and update frequency are controlled by the third-party provider.",

  thirdPartyLinkDisclaimer:
